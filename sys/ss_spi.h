...
struct PinConfig pin_config_spi1 = {
    {{PIN('A', 6), GPIO_MODE_AF}, {PIN('A', 7), GPIO_MODE_AF}, {PIN('A', 5), GPIO_MODE_AF}, {PIN('A', 4), GPIO_MODE_AF} },
    4
};

struct PinConfig pin_config_spi2 = {
    {{PIN('B', 14), GPIO_MODE_AF}, {PIN('B', 15), GPIO_MODE_AF}, {PIN('B', 13), GPIO_MODE_AF}, {PIN('B', 12), GPIO_MODE_AF} },
    4
};

struct PinConfig pin_config_spi3 = {
    {{PIN('C', 11), GPIO_MODE_AF}, {PIN('C', 12), GPIO_MODE_AF}, {PIN('C', 10), GPIO_MODE_AF}, {PIN('A', 15), GPIO_MODE_AF} },
    4
};
